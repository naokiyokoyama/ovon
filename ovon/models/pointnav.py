...
class PointNavResNetTransformerPolicy(NetPolicy):
    ...
    def from_config(
        ...
        **kwargs,
        ...
        return cls(
            ...
            action_space=action_space,
            transformer_config=config.habitat_baselines.rl.policy.transformer_config,
    ...
    def evaluate_actions(self, *args, **kwargs):
        return super().evaluate_actions(*args, **kwargs)
...
class PointNavResNetNet(Net):
    ...
    def __init__(
        ...
        if backbone.startswith("vc1"):
            ...
            self.visual_encoder = Vc1Wrapper(use_obs_space, model_id=model_id)
